...
public class AddressCompositionTest
{
    ...
    public void testApply() throws Exception
    {
        ...
        final BigInteger expectedTransformedKey = new BigInteger("00010966776006953D5567439E5E39F86A0D273BEED61967F6", 16);
        ...
        final BigInteger actualTransformedKey = new BigInteger(1, transformedKey);
